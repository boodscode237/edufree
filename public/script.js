...
//     updateProfiles(selectedLevel);
//   });

//   profileSelect.addEventListener("change", function () {
//     const selectedLevel = educationLevelSelect.value;
//     const selectedProfile = profileSelect.value;
//     updateTopics(selectedLevel, selectedProfile);
//   });

//   function updateProfiles(level) {
//     profileSelect.innerHTML = '<option value="">Select...</option>';
//     if (level) {
//       const profiles = Object.keys(educationProfiles[level]);
...
//   function updateTopics(level, profile) {
//     topicSelect.innerHTML = '<option value="">Select...</option>';
//     if (level && profile) {
//       const topics = educationProfiles[level][profile];
...
//         "whatsapp"
//       ).innerHTML = `📞 WhatsApp: <a href="${contact.whatsapp}">Chat</a>`;
//       document.getElementById(
//         "telegram"
//       ).innerHTML = `📨 Telegram: <a href="${contact.telegram}">${contact.telegram}</a>`;
//       document.getElementById(
//         "email"
